...
export const projetos = {
    "Projetos Interdisciplinares": {
        ...
        "Ateliê do Chocolate": {
            "foto": returnPathImg('ateliechocolate'),
        ...
        "Barberfashion": {
            "foto": returnPathImg('barberfashion'),
        ...
        "Predimec Manutenções App": {
            "foto": returnPathImg('predimecmanutapp'),
    ...
    "Pessoais": {
        ...
        "Fut Simulator": {
            "foto": returnPathImg('futsimulator'),
